...
{
    public float damage = 10f; // Da�o por golpe al jugador
    //private float delay;
    ...
    {
        // Comprueba si el objeto con el que colision� tiene un componente PlayerHealth
        PlayerHealth playerHealth = other.GetComponent<PlayerHealth>();

        //delay += Time.deltaTime;
        //if (delay > delayCD)
        //{
            // Llamado al metodo que aplica el da�o
